...
function HC_spot(context, location, radius, rect_map, camera, pen, ident)
{
...
function HC_line(context, tail, head, rect_map, camera, pen, ident)
{
...
function HC_rect(context, sw, ne, rect_map, camera, pen, ident)
{
    ...
    return HC_polyline(context, data, rect_map, camera, pen, ident);
}

function HC_polyline(context, data, rect_map, camera, pen, ident)
{
...
function HC_label(context, location, offset, text, rect_map, camera, pen, ident)
{
    var loc = camera.shoot(location);
    if (!ident)
	ident = random_identifier();
...
function HC_arrow(context, tail, head, rect_map, camera, pen, ident)
{
    var dir = Diff(head, tail);
    //dir = Mult(1/Norm(dir), dir);
...
{
    return HC_spot(context, location, radius, rect_map, camera, pen, ident);
}

function line(tail, head, ident)
{
    return HC_line(context, tail, head, rect_map, camera, pen, ident);
}

function rect(sw, ne, ident)
{
    return HC_rect(context, sw, ne, rect_map, camera, pen, ident)
}
...
{
    return HC_label(context, location, offset, text, rect_map, camera, pen, ident);
}

function arrow(tail, head, ident)
{
    return HC_arrow(context, tail, head, rect_map, camera, pen, ident);
}
